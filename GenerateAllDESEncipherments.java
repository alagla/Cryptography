...
/*
 * This program prints all ciphertexts from a known plaintext by iterating
...
public class GenerateAllDESEncipherments {
	...
	public static void main(String... args) {
		if (args.length != 1) {
			System.err.println("Usage: java GenerateAllDESEncipherments <plaintext string>");
			System.exit(1);
		}

		String plaintextString = args[0];

		if (plaintextString.length() != 12) {
			System.err.println("The plaintext must contains 12 ones and zeroes.");
			System.exit(1);
		}
		for (Byte c: plaintextString.getBytes()) {
			if (c != '0' && c != '1') {
				System.err.println("The plaintext must contains 12 ones and zeroes.");
				System.exit(1);
			}
